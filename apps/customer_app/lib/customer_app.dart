      ...
      body: StreamBuilder<Product?>(
          ...
          builder: (context, s) {
            ...
            return ListView(padding: const EdgeInsets.all(20), children: [
              ...
              PriceText(p.price),
              Text(
                  'Unit: ${unitDisplayName(p.unit)} · ${available ? 'Available Stock: ${p.stockQty}' : 'Out of Stock'}'),
              const SizedBox(height: 16),
              Text(p.description),
              const SizedBox(height: 16),
              ...
              Row(children: [
                QuantityStepper(
                  value: count,
                  max: p.stockQty,
                  onChanged: (newVal) => setState(() => qty = newVal),
                ),
                const Spacer(),
              ...
              HhButton(
                  label: available ? 'Add to Cart' : 'Out of Stock',
                  busy: busy,
                  onPressed: !available
                      ? null
                      : () async {
    ...
    return Column(children: [
                          ...
                          child: Column(
                              ...
                              children: [
                                ...
                                ListTile(
                                    ...
                                    title: Text(i.name),
                                    subtitle:
                                        Text('${vnd(i.price)} / ${unitDisplayName(i.unit)}'),
                                    trailing: IconButton(
                                        tooltip: 'Remove',
      ...
      Padding(
          ...
          child: Column(children: [
            ...
            HhButton(label: 'Proceed to Checkout', onPressed: onCheckout),
          ])),
    ]);
  }
}
